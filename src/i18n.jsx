import { 
  PROFILE_EN, PROJECTS_EN, EXPERIENCE_EN, EDUCATION_EN, SKILL_GROUPS_EN,
  PROFILE_FR, PROJECTS_FR, EXPERIENCE_FR, EDUCATION_FR, SKILL_GROUPS_FR 
} from './data.js';
...
export const DATA = {
  en: { PROFILE: PROFILE_EN, PROJECTS: PROJECTS_EN, EXPERIENCE: EXPERIENCE_EN, EDUCATION: EDUCATION_EN, SKILL_GROUPS: SKILL_GROUPS_EN },
  fr: { PROFILE: PROFILE_FR, PROJECTS: PROJECTS_FR, EXPERIENCE: EXPERIENCE_FR, EDUCATION: EDUCATION_FR, SKILL_GROUPS: SKILL_GROUPS_FR }
};
